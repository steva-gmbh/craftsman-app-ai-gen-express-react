...
export default function DataTable<T>({
  ...
  return (
    <div className="relative">
      ...
      <div className={`rounded-${isPaginated ? 't' : ''}-lg border border-gray-300 dark:border-gray-700 overflow-hidden`}>
      ...
      {isPaginated && (
        <div className="rounded-b-lg border border-t-0 border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800">
          <Pagination
            currentPage={onPageChange ? Math.max(1, currentPage) : Math.max(1, localCurrentPage)}
            totalPages={onPageChange ? Math.max(1, totalPages) : Math.max(1, localTotalPages)}
